...
var questions = ['¿Qué tan satisfech@ estás con nuestro servicio?', '¿Qué tan satisfech@ estás con nuestro servicio?', '¿Qué tan satisfech@ estás con nuestro servicio?', '¿Qué tan satisfech@ estás con nuestro servicio?']
var q = 0;
...
var monkey_messages = ['terrible', 'malo', 'no muy bueno', 'promedio', 'bueno', 'excelente', 'impresionante']; // Monkey array
var rabbit_messages = ['terrible', 'malo', 'no muy bueno', 'promedio', 'bueno', 'excelente', 'impresionante']; // Rabbit array
var panda_messages = ['terrible', 'malo', 'no muy bueno', 'promedio', 'bueno', 'excelente', 'impresionante']; // Panda array
var lion_messages = ['terrible', 'malo', 'no muy bueno', 'promedio', 'bueno', 'excelente', 'impresionante']; // Lion array
